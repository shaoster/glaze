...
| Backend: Glaze models, API endpoints, image FK, admin, R2 storage                                                                        | [`.agents/skills/glaze-backend/SKILL.md`](.agents/skills/glaze-backend/SKILL.md)                       |
| Frontend: Glaze components, type pipeline, state chips, R2 upload                                                                        | [`.agents/skills/glaze-frontend/SKILL.md`](.agents/skills/glaze-frontend/SKILL.md)                     |
...
| **Bootstrapping**: Dev environment setup, shell bootstrap, worktree navigation, worktree database isolation, running servers, dev login (mock-IdP sign-in), prod backup/local restore, .env.local pitfalls | [`.agents/skills/dev-environment/SKILL.md`](.agents/skills/dev-environment/SKILL.md)                   |
