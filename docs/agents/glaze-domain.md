...
- **Remote ML** (`/tools/piece_image_segment_service.py`): Optional serverless offload via Modal.com
...
- **Microservice**: Located at `tools/piece_image_segment_service.py`, designed for deployment to **Modal.com**.
