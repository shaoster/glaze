    ...
    pieces: [
      {
        ...
        name: "V1",
        state: "completed",
        images: [{ url: "https://images.unsplash.com/photo-1593150501174-d8200671607f?w=100", caption: "Test" }],
      },
      {
        id: "p4",
        name: "V2",
        state: "completed",
        images: [{ url: "https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=100", caption: "Test" }],
      },
    ],
  },
];
      ...
      handlers: [
        http.get("/api/analysis/glaze-combination-images/", () => {
          return HttpResponse.json([
            ...mockData,
            {
              glaze_combination: { id: "gc3", name: "Tenmoku", is_public: true },
              pieces: [
                {
                  id: "p5",
                  name: "T1",
