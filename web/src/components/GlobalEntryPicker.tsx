...
export default function GlobalEntryPicker({
  globalName,
  open,
  onClose,
  onSelect,
}: GlobalEntryPickerProps) {
          ...
          {relatedFilterDefs.map((rf) =>
            rf.multiple ? (
              <Autocomplete
                ...
                onChange={(_e, val) =>
                  handleGlobalPickerFilter(rf.paramKey, val)
                }
                renderInput={(params) => (
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          handleBoolFilter(name, e.target.checked, true)
                        }
                      />
                    }
                  />
                  <FormControlLabel
                    ...
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          handleBoolFilter(name, e.target.checked, false)
                        }
                      />
                    }
                  />
