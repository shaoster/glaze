...
Glaze uses agent workflows for planning, implementation, offline analysis, and docs maintenance. If you want to work with the repo through an agent, use the workflow that matches the task:
...
- `docs-human`: reconcile duplicated docs and keep human-facing READMEs aligned after structural changes.
