    ...
    <div style={{
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '10px 16px 80px' }}>
        ...
        <div style={{
          ...
          <span style={{ color: SC_MUTE }}>updates live</span>
        </div>

        <div style={{
          border: `2px solid ${SC_INK}`, borderRadius: 14,
          padding: 10, background: SC_PAPER_2,
        ...
        <div style={{
          ...
          <span>fields</span>
          <span style={{ color: SC_MUTE }}>{sharedCount}/{fields.length} shared</span>
        </div>
        <div style={{ fontSize: 12, color: SC_DIM, marginBottom: 8, fontFamily: handSC, lineHeight: 1.35 }}>
          Tap to flip a detail on or off.
        </div>
