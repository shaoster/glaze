"""Account lifecycle endpoints for the Glaze API.

This module keeps the export and destructive account-deletion flows separate from
the session/login/bootstrap endpoints in ``auth_views.py``.
"""
